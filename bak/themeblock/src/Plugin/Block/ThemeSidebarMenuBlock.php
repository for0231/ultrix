...
/**
 * @file
 * Contains \Drupal\themeblock\Plugin\Block\ThemeSidebarMenuBlock.
 */
namespace Drupal\themeblock\Plugin\Block;
 ...
 *
 * @Block(
 *   id = "themesidebarmenublock",
 *   admin_label = @Translation("ThemeSidebar Menu"),
 *   category = @Translation("Custom"),
 * )
 */
class ThemeSidebarMenuBlock extends BlockBase  {

  public function getCacheMaxAge() {
    return 0;
  }

  private function setActiveTrailMenu($tree, $active_trail, $tr = array()) {
  ...
  private function setActive($obj) {
    if($obj instanceof \Drupal\Core\Menu\MenuLinkTreeElement) {
