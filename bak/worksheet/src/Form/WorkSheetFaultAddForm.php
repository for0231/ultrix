...
/**
 * @file
 * Contains \Drupal\worksheet\Form\WorkSheetFaultAddForm.
 */
...
class WorkSheetFaultAddForm extends ContentEntityForm {
  /**
   * {@inheritdoc}
   */
