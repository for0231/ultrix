...
/**
 * @file
 * Contains \Drupal\worksheet\Form\WorkSheetLogisticsAddForm.
 */
...
class WorkSheetLogisticsAddForm extends ContentEntityForm {
  /**
   * {@inheritdoc}
   */
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['tid']['widget']['#default_value'] = 500;
    unset($form['op_dept']);
    unset($form['remember']);
    $form['#theme'] = 'logistics_add_form';
    return $form;
  }
  /**
   * {@inheritdoc}
