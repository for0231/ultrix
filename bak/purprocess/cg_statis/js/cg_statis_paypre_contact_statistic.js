(function($, Drupal, drupalSettings) {
  "use strict";
  Drupal.behaviors.paypre_contact = {
    attach: function (context) {

      $("#statis").jqGrid({
        url: Drupal.url('ajax/cg_statis/paypre/contact/statistic/collection'),
        datatype: "json",
			  height : 'auto',
        colNames: ['ID', '合同编号', '币种', '合同金额', '需求数量', '已采购', '待采购', '按时率', '超时率', '开始时间', '截止时间'],
        colModel:[
          {name: 'id', index: 'id', sorttype: "int", width: 30, editable: false},
          {name: 'name', index: 'name', editable: false},
          {name: 'ftype', index: 'ftype', editable: false},
          {name: 'camount', index: 'camount', editable: false},
          ...
          {name: 'start',index:'start', editable: false, sorttype:"date"},
          {name: 'end',index:'end', editable: false, sorttype:"date"},
        ],
				rowNum : 10,
				rowList : [10, 50, 100],
				pager : '#statisnav',
