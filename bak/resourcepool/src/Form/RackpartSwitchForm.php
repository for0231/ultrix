...
class RackpartSwitchForm extends FormBase {
  /**
   * {@inheritdoc}
   */
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['filters']['file_upload'] = array(
      '#type'=>'file',
      '#title'=>'交换机ip对应关系表',
      '#description' => "请上传交换机ip对应关系表,允许的文件格式为xlsx xls",
      '#attributes' => array(
        'name' => 'myfile',
      ),
    );
  ...
  public function format_excel2array($filePath = '',$sheet = 0,$file_name)
  {
    ...
    $rows = \Drupal::service('resourcepool.dbservice')->insert_switchip($data);
    return $rows;
  }
}
