...
/**
 * @file
 * Contains Drupal\offical\Tests\StandardTest.
 */

namespace Drupal\offical\Tests;
...
/**
 * Tests Offical installation profile expectations.
 *
 * @group offical
 */
class StandardTest extends WebTestBase {
  ...
  function testStandard() {
    ...
    // offical profile modules are enabled.
